...
import {DescriptionSubcategory} from './DescriptionSubcategory';
import {AviableSizesSubcategory} from './AviableSizesSubcategory';
...
export const SubcategoryComponent = ({subcategory}: Props) => {
  const {
    id,
    name,
    images,
